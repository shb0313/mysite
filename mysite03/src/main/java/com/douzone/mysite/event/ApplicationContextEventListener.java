...
public class ApplicationContextEventListener {
	...
	public void handleContextRefreshedEvent() {
		...
		propertyValues.add("proflie", site.getProfile());
		propertyValues.add("welcome", site.getWelcome());
		propertyValues.add("description", site.getDescription());
		
		GenericBeanDefinition beanDifinition = new GenericBeanDefinition();
		beanDifinition.setBeanClass(SiteVo.class);
		beanDifinition.setPropertyValues(propertyValues);
		
		registry.registerBeanDefinition("site", beanDifinition);
